...
export default function HomePageNotLoggedIn() {
  ...
  return (
    <section className="not-logged-in">
      ...
      <p><span className={styles.emphasis}>Met Helper</span> is designed for meteorologists for meteorologists to assist in streamlining their daily duties. Easily forecast fro the cities you need, update you data from any computer, and track you accuracy.</p>
